...
# Call the function
plot_country_smoothed('Germany', 'analysis/food-insecurity/visuals/germany_meal_affordability_smoothed.png')
plot_country_smoothed('UK', 'analysis/food-insecurity/visuals/uk_meal_affordability_smoothed.png')
